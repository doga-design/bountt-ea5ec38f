...
-- Replace create_expense_with_splits (with p_expense_type) to add amount + split sum validation
...
-- Replace edit_expense (with p_expense_type) to add amount + split sum validation

...
export default function Splash() {
  ...
  return (
    <div className="screen-container bg-bountt-orange overflow-hidden flex items-center justify-center">
      <h1 className="bountt-wordmark text-5xl text-primary-foreground animate-fade-in">
        bountt<span className="text-bountt-dark">.</span>
      </h1>
    </div>
  );
}
